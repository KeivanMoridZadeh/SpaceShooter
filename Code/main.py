...
class Player(pygame.sprite.Sprite):
    def __init__(self, groups):
        ...
        # Cooldown
        self.can_shoot = True
        self.liser_shoot_time = 0
        self.cooldown_duration = 400

        # Mask
        self.mask = pygame.mask.from_surface(self.image)
        
    def laset_timer(self):
...
def collision():
    global running
    collision_sprite = pygame.sprite.spritecollide(player, metor_sprite, True, pygame.sprite.collide_mask)
    if collision_sprite:
        running = False
    for laser in laser_sprites:
        collided_sprites = pygame.sprite.spritecollide(laser, metor_sprite, True)
        if collided_sprites:
            laser.kill()
...
metor_sprite = pygame.sprite.Group()
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == metor_event:
            ...
            Metor(meteor_surf, (x, y), (all_sprites, metor_sprite))
